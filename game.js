...
kaboom({
 ...
 //  ]);
    ...
    //pos(width() / 2 + 2, height() / 2  + 2), color(0, 0, 0), // Stroke color (black)
    add([
      text('The Pied Piper', 32),
      origin('center'),
