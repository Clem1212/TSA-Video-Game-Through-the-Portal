...
scene("title", () => {
    ...
    // Add stroke for "Aladdin" text
    add([
        text("Aladdin", 32),
        origin("center"),
        pos(width() / 2 + 2, height() / 3 + 2), // Slightly offset for stroke effect
...
scene("rules", () => {
    ...
    add([
        ...
        color(1, 1, 0), // Main text color (green)
    ]);
    ...
    // Add stroke for "Press SPACE to start the game."
    add([
