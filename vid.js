...
// Start with the title screen
  ...
  //not moving add 'varname' like 'virus2' if remvove it moves
    ...
    add([sprite('bg'), layer('bg'), pos(1200,-870), scale(1)])

    add([sprite('bg'), layer('bg'), pos(-700,-870), scale(1)])
    add([sprite('bg'), layer('bg'), pos(1500,-870), scale(1)])

// Define positions for text based on the previously identified "*" positions
const textPositions = [
  { x: 900, y: 70, text: "Running away from home, Hansel and Gretel run into the forest," },
  { x: 702, y: 20, text: "They go into the candy house, and eat food." },
  { x: 500, y: 100, text: "While in the house, they find a spell book with a magical portal and fall into it," },
  { x: 400, y: 30, text: "Dragging the witch in with them..." },
  { x: 45, y: 120, text: " They travel through different types of Fairy Tales in different dimensions and different game modes..." },
];
