...
kaboom({
 ...
 // loadSprite('mushroom', 'assets/rat.png');
  ...
  loadSprite('2-top-left', '/NMFoJel.png')
  loadSprite('2-top-right', '/fovDvKp.png')
  
  loadSprite('WBC-going-left', 'gWcTlxG.png')
 ...
 //AiRF3GI.png
  ...
  //sRlE71R.png
  loadSprite('bg', '/NHs0alw.png') //    add([sprite('bg'), layer('bg'), pos(-200,-300), scale(1)])
 //https://imgur.com/Mnx94xS
  loadSprite('virus2', '2Kfebjj.png')
  loadSprite('virus1', 'IjRMvZ6.png')
  
  //wind
  loadSprite('testing', '/8HiUBSH.png')
...
// Start with the title screen
  ...
  //sprite for =
    const levelCfg = {
      ...
      'F': [sprite('WBC-going-right'),  'testing2',scale(0.75), solid(), ],
     'i': [sprite('2-top-right'),  'testing',  scale(0.045), solid(),  ],
  ...
  //not moving add 'varname' like 'virus2' if remvove it moves
    ...
    add([sprite('bg'), layer('bg'), pos(-10,0), scale(3)])
